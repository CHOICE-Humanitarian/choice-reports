...
public class ReportNarrativeGenPage extends ReportNarrativeGenPageGen<BaseModelPage> {
	...
	protected void _pagination(JsonObject pagination) {
		...
		Long foundNum = searchListReportNarrative_.getQueryResponse().getResponse().getNumFound().longValue();
	...
	protected void _query(JsonObject query) {
		...
		Long num = searchListReportNarrative_.getQueryResponse().getResponse().getNumFound().longValue();
		String q = "*:*";
	...
	protected void _pageImageUri(Wrap<String> c) {
			c.o("/png/api/report-narrative-999.png");
	}

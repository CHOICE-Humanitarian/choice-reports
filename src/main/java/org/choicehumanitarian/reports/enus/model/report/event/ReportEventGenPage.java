...
public class ReportEventGenPage extends ReportEventGenPageGen<BaseModelPage> {
	...
	protected void _pagination(JsonObject pagination) {
		...
		Long foundNum = searchListReportEvent_.getQueryResponse().getResponse().getNumFound().longValue();
	...
	protected void _query(JsonObject query) {
		...
		Long num = searchListReportEvent_.getQueryResponse().getResponse().getNumFound().longValue();
		String q = "*:*";
	...
	protected void _pageImageUri(Wrap<String> c) {
			c.o("/png/api/report-event-999.png");
	}

...
public class ConfigKeys {
	...
	/**
	 * Enables SSL Passthrough configuration. 
	 **/
	 ...
	 * 
	 **/
	public static final String ENCRYPTION_SALT = "encryptionSalt";
	 ...
	 * 
	 **/
	public static final String ACCOUNT_YOUTUBE = "accountYoutube";

	/**
	 * 
	 **/
	public static final String ACCOUNT_PINTEREST = "accountPinterest";

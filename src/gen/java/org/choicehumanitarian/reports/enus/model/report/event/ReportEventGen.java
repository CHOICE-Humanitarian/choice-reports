 ...
 * <ol>
 * <li>You can add a class comment "{@inheritDoc}" if you wish to inherit the helpful inherited class comments from class ReportEventGen into the class ReportEvent. 
 * </li>
 * </ol>
 * <h1>About the ReportEvent class and it's generated class ReportEventGen&lt;BaseModel&gt;: </h1>
 * <p>
 * This Java class extends a generated Java class built by the <a href="https://github.com/computate-org/computate">https://github.com/computate-org/computate</a> project. 
 * Whenever this Java class is modified or touched, the watch service installed as described in the README, indexes all the information about this Java class in a local Apache Solr Search Engine. 
 * If you are running the service, you can see the indexed data about this Java Class here: 
 * </p>
 * <p><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.choicehumanitarian.reports.enus.model.report.event.ReportEvent">Find the class ReportEvent in Solr. </a></p>
 * <p>
 ...
 * This creates a new Java class org.choicehumanitarian.reports.enus.model.report.event.ReportEventPage. 
 * </p>
 ...
 * This means that the newly created class org.choicehumanitarian.reports.enus.model.report.event.ReportEventPage extends org.choicehumanitarian.reports.enus.model.base.BaseModelPage. 
 * </p>
 ...
 * </p>
 * <p>This class contains a comment "ApiTag: Calendar Item", which groups all of the OpenAPIs for ReportEvent objects under the tag "Calendar Item". 
 * </p>
 * <p>This class contains a comment "ApiUri: /api/calendar-item", which defines the base API URI for ReportEvent objects as "/api/calendar-item" in the OpenAPI spec. 
 * </p>
 * <p>
 * Delete the class ReportEvent in Solr: 
 * curl 'http://localhost:8983/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomCanonique_enUS_indexed_string:org.choicehumanitarian.reports.enus.model.report.event.ReportEvent&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'
 * </p>
 * <p>
 * Delete  the package org.choicehumanitarian.reports.enus.model.report.event in Solr: 
 * curl 'http://localhost:8983/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomEnsemble_enUS_indexed_string:org.choicehumanitarian.reports.enus.model.report.event&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'
 * </p>
 * <p>

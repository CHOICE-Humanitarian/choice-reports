 ...
 * <ol>
 * <li>You can add a class comment "{@inheritDoc}" if you wish to inherit the helpful inherited class comments from class ChoiceReportGenPageGen into the class ChoiceReportGenPage. 
 * </li>
 * <li>You can add a class comment "Api: true" if you wish to GET, POST, PATCH or PUT these ChoiceReportGenPage objects in a RESTful API. 
 * </li>
 * </ol>
 * <h1>About the ChoiceReportGenPage class and it's generated class ChoiceReportGenPageGen&lt;BaseModelPage&gt;: </h1>
 * <p>
 * This Java class extends a generated Java class built by the <a href="https://github.com/computate-org/computate">https://github.com/computate-org/computate</a> project. 
 * Whenever this Java class is modified or touched, the watch service installed as described in the README, indexes all the information about this Java class in a local Apache Solr Search Engine. 
 * If you are running the service, you can see the indexed data about this Java Class here: 
 * </p>
 * <p><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.choicehumanitarian.reports.enus.model.report.ChoiceReportGenPage">Find the class ChoiceReportGenPage in Solr. </a></p>
 * <p>
 * The extended class ending with "Gen" did not exist at first, but was automatically created by the same watch service based on the data retrieved from the local Apache Server search engine. 
 * The extended class contains many generated fields, getters, setters, initialization code, and helper methods to help build a website and API fast, reactive, and scalable. 
 * </p>
 * <p>
 * Delete the class ChoiceReportGenPage in Solr: 
 * curl 'http://localhost:8983/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomCanonique_enUS_indexed_string:org.choicehumanitarian.reports.enus.model.report.ChoiceReportGenPage&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'
 * </p>
 * <p>
...
public abstract class ChoiceReportGenPageGen<DEV> extends BaseModelPage {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.choicehumanitarian.reports.enus.model.report.ChoiceReportGenPage&fq=entiteVar_enUS_indexed_string:DEFAULT_MAP_LOCATION">Find the entity DEFAULT_MAP_LOCATION in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDEFAULT_MAP_LOCATION(String o) {
		this.DEFAULT_MAP_LOCATION = ChoiceReportGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o);
	}
	...
	protected ChoiceReportGenPage DEFAULT_MAP_LOCATIONInit() {
	...
	public static String staticSearchFqDEFAULT_MAP_LOCATION(SiteRequestEnUS siteRequest_, String o) {
		return ChoiceReportGenPage.staticSearchStrDEFAULT_MAP_LOCATION(siteRequest_, ChoiceReportGenPage.staticSearchDEFAULT_MAP_LOCATION(siteRequest_, ChoiceReportGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.choicehumanitarian.reports.enus.model.report.ChoiceReportGenPage&fq=entiteVar_enUS_indexed_string:DEFAULT_MAP_ZOOM">Find the entity DEFAULT_MAP_ZOOM in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDEFAULT_MAP_ZOOM(String o) {
		this.DEFAULT_MAP_ZOOM = ChoiceReportGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o);
	}
	...
	protected ChoiceReportGenPage DEFAULT_MAP_ZOOMInit() {
	...
	public static String staticSearchFqDEFAULT_MAP_ZOOM(SiteRequestEnUS siteRequest_, String o) {
		return ChoiceReportGenPage.staticSearchStrDEFAULT_MAP_ZOOM(siteRequest_, ChoiceReportGenPage.staticSearchDEFAULT_MAP_ZOOM(siteRequest_, ChoiceReportGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o)));
	}
	...
	public Object obtainChoiceReportGenPage(String var) {
		...
		switch(var) {
			...
			case "DEFAULT_MAP_LOCATION":
				return oChoiceReportGenPage.DEFAULT_MAP_LOCATION;
			case "DEFAULT_MAP_ZOOM":
				return oChoiceReportGenPage.DEFAULT_MAP_ZOOM;
	...
	public static Object staticSetChoiceReportGenPage(String entityVar, SiteRequestEnUS siteRequest_, String o) {
		...
		case "DEFAULT_MAP_LOCATION":
			return ChoiceReportGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o);
		case "DEFAULT_MAP_ZOOM":
			return ChoiceReportGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o);
		case "choiceReportCount":
	...
	public static Object staticSearchChoiceReportGenPage(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		...
		case "DEFAULT_MAP_LOCATION":
			return ChoiceReportGenPage.staticSearchDEFAULT_MAP_LOCATION(siteRequest_, (JsonObject)o);
		case "DEFAULT_MAP_ZOOM":
			return ChoiceReportGenPage.staticSearchDEFAULT_MAP_ZOOM(siteRequest_, (BigDecimal)o);
		case "choiceReportCount":
	...
	public static String staticSearchStrChoiceReportGenPage(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		...
		case "DEFAULT_MAP_LOCATION":
			return ChoiceReportGenPage.staticSearchStrDEFAULT_MAP_LOCATION(siteRequest_, (JsonObject)o);
		case "DEFAULT_MAP_ZOOM":
			return ChoiceReportGenPage.staticSearchStrDEFAULT_MAP_ZOOM(siteRequest_, (Double)o);
		case "choiceReportCount":
	...
	public static String staticSearchFqChoiceReportGenPage(String entityVar, SiteRequestEnUS siteRequest_, String o) {
		...
		case "DEFAULT_MAP_LOCATION":
			return ChoiceReportGenPage.staticSearchFqDEFAULT_MAP_LOCATION(siteRequest_, o);
		case "DEFAULT_MAP_ZOOM":
			return ChoiceReportGenPage.staticSearchFqDEFAULT_MAP_ZOOM(siteRequest_, o);
		case "choiceReportCount":
